...
<body>
    <div class="login-div">
        ...
        <div class="sub-title">Login terlebih dahulu</div>
        <div class="social-media">
            ...
            <a href="#" style="text-decoration: none;"><i class="fab fa-google-plus-g"></i></a>
        </div>
        <form name="form" class="fields" action="config/login.php" method="POST">
            <div class="username"><svg fill="#999" viewBox="0 0 20 20">
                ...
                <input type="username" name="username" class="user-input" placeholder="Username" id="username">
            </div>
            <div class="password"><svg fill="#999" viewBox="0 0 20 20">
                ...
                <input type="password" name="password" class="pass-input" placeholder="Password" id="password">
            ...
            <div class="login">
                <button name="login" type="submit" class="btn btn-primary" style="border: none; width: 100%; border-radius: 40px; background: #e3edf7; color: #555; outline: none;"><a id="login"><span>Login</span></a></button>
            </div>
            <div class="link">
