...
<head>
    ...
    <title>Jacket Shop | Profil</title>
</head>
<style>
*{
...
<body>
    <div class="login-div">
        ...
        <form action="config/edit.php" method="POST" class="fields">
            <div class="username"><svg fill="#999" viewBox="0 0 20 20">
                ...
                <input type="username" name="username" class="user-input" placeholder="Ubah Username" id="username">
            </div>
            <div class="email"><svg fill="#999" viewBox="0 0 20 20">
                ...
                <input type="email" name="email" class="user-input" placeholder="Ubah Email" id="email">
            </div>
            <div class="password"><svg fill="#999" viewBox="0 0 20 20">
                ...
                <input type="password" name="password" class="pass-input" placeholder="Ubah Password" id="password">
            ...
            <div class="daftar">
                <button style="border: none; width: 100%; border-radius: 40px; background: #e3edf7; color: #555; outline: none;"><a id="daftar"><span>EDIT PROFIL</span></a></button>
            </div>
        </form>
        <br>
        <div class="daftar">
        <form action="config/hapus.php" method="POST">
                    ...
                    <button type="submit" style="border: none; width: 100%; border-radius: 40px; background: #e3edf7; color: #555; outline: none;"><a id="daftar"><span>HAPUS AKUN</span></a></button>
        </form>
        </div>
    </div>
